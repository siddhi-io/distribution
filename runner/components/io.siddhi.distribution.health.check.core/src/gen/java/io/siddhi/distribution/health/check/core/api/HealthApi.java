...
@Component(
        name = "siddhi-distribution-health-check-api",
...
public class HealthApi implements Microservice {
    ...
    @io.swagger.annotations.ApiOperation(value = "Fetches the status of the Siddhi Runner.",
            notes = "Fetches the status of the Siddhi Runner. ", response = ServerStatus.class, tags = {"Artifact",})
    @io.swagger.annotations.ApiResponses(value = {
            @io.swagger.annotations.ApiResponse(code = 200,
                    message = "The state of the Siddhi Runner is successfully retrieved.",
